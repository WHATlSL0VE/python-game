...
class Score(object):
    def __init__(self):
        ...
        self.x = 70
        self.y = 15
        c.create_text(self.x, self.y, text="Кількість з'їжених яблук: {}".format(self.score), font="Arial 20",
...
game_over_text = c.create_text(WIDTH / 2, HEIGHT / 2, text="Ти зазнав поразки, друже!",
